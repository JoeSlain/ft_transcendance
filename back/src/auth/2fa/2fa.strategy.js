...
var TwoFactorStrategy = /** @class */ (function (_super) {
    __extends(TwoFactorStrategy, _super);
    function TwoFactorStrategy(usersService) {
    ...
    TwoFactorStrategy.prototype.validate = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersService.getById(payload.userId)];
                    case 1:
                        user = _a.sent();
...
}((0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, "2fa")));
