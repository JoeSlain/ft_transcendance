...
var TwoFactorAuthenticationService = /** @class */ (function () {
    function TwoFactorAuthenticationService(usersService, userRepo) {
        this.usersService = usersService;
        this.userRepo = userRepo;
    }
    TwoFactorAuthenticationService.prototype.generateTwoFactorAuthenticationSecret = function (user) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        otpauthUrl = otplib_1.authenticator.keyuri(user.email, "transcendence2fa", secret);
                        return [4 /*yield*/, this.usersService.setTwoFactorAuthenticationSecret(secret, user.id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, { otpauthUrl: otpauthUrl }];
                }
            });
        });
    };
    TwoFactorAuthenticationService.prototype.pipeQrCodeStream = function (stream, otpauthUrl) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    TwoFactorAuthenticationService.prototype.isTwoFactorAuthenticationCodeValid = function (twoFactorAuthenticationCode, user) {
        return __awaiter(this, void 0, void 0, function () {
            var userWithSecret;
            return __generator(this, function (_a) {
                switch (_a.label) {
